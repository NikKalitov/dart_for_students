...
void conditionalConstructs() {
  /// В программировании не обойтись без условных конструкций.
  /// Например, конструкция если(){} иначе{}
  // int a = 5;
  // int b = 8;

  /// Цикл если (if)
  /// if(*условие*){*тело цикла*}
  /// Если выполняется условие, записанное в круглых скобках, то выполняется
  /// тело цикла.
  /// В данном примере, если a > b, то мы выводим соответствующий текст
  // if (a > b) {
  //   print('a > b');
  // }
  ...
  /// Цикл иначе (else)
  /// else{*тело цикла*}
  /// Этот цикл выполняется тогда, когда идущие до него циклы if не отработали
  // else {
  //   print('a < b');
  // }

  /// Для проверки нескольких условий обычно используют следующую схему:
  // if (a > b) {
  //   print('a > b');
  // } else if (a < b) {
  //   print('a < b');
  // } else {
  //   print('a не больше и не меньше b');
  // }

  /// else if(*условие*){*тело цикла*} лучше подходит для перебора условий,
  /// поскольку в него можно записать это самое условие

  /// Конструкция switch/case
  /// Эта конструкция лучше подходит для перебора условий одного типа.
  /// Она более оптимизирована в сравнении с конструкцией if(){}else if{}else{}
  /// В круглые скобки после слова switch передается сравниваемое значение.
  /// Это может быть переменная, операция сравнения и т.д.
  /// После блока case пишутся возможные варианты сравниваемого значения.
  // switch (5 > 10) {
  //   case true:
  //     print('true');
  //     break;
  ...
  //     /// Оператор break дает программе знать, где у блока case находится конец.
  //     break;

  //   /// default представляет собой случай, когда сравниваемое выражение не
  //   /// подходит под заготовленные нами условия
  //   default:
  //     print('i do not know');
  // }

  /// Пример работы конструкции switch/case
  // int value = 10;
  // switch (value) {
  //   case 1:
  //     print('value равно одному');
  //     break;
  //   case 2:
  //     print('value равно двум');
  //     break;
  //   case 3:
  //     print('value равно трём');
  //     break;
  //   case 4:
  //     print('value равно четырём');
  //     break;
  //   case 5:
  //     print('value равно пяти');
  //     break;
  //   default:
  //     print('value не равно предусмотренному значению');
  // }

  /// Тернарный оператор ?:
  /// Данный оператор является альтернативой конструкции if(){}else{}.
  /// Он приятнее глазу и часто используется при создании интерфейсов во FLutter.

  /// условие
  ///   ? *выполняется, если условие верно*
  ///   : *выполняется, если условие не верно*;
  // 5 > 6 ? print('5 > 6') : print('5 < 6');
}
